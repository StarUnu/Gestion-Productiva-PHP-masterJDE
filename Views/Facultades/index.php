            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="content">
                        ...
                        <br>
                        <form method="post" action="<?php echo BASE_URL;?>Facultades/Guardar/">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Nombre</label>
                                            <input type="text" required maxlength="100" class="form-control" name="Nombre" placeholder="Nombre" value="<?php echo $facultad->Nombre;?>">
                                        </div>
                                    </div>
                        ...
                        <nav><ul class="pagination">
                            <?php if(!empty($totalPages)):for($i=1; $i<=$totalPages; $i++):  
                                        if($i == 1):?>
                                        <li class='active'  id="<?php echo $i;?>"><a href='<?php echo BASE_URL;?>Facultades/Pagination/Page/<?php echo $i;?>'><?php echo $i;?></a></li> 
                                        <?php else:?>
                                        <li id="<?php echo $i;?>"><a href='<?php echo BASE_URL;?>Facultades/Pagination/Page/<?php echo $i;?>'><?php echo $i;?></a></li>
                                    <?php endif;?>          
                            <?php endfor;endif;?>
                        </ul></nav>
                    </div>
...
$(document).ready(function(){
    $('.pagination').pagination({
            ...
            onPageClick : function(pageNumber) {
                ...
                $("#target-content").load(base + "Facultades/Pagination/Page/" + pageNumber);
            }
        });
    });
</script>