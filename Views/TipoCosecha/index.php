								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" required maxlength="100" class="form-control" name="Descripcion" placeholder="Descripcion" value="<?php echo $tipocosecha->Descripcion;?>">
										</div>
									</div>
									<input type="hidden" name="Id" value="<?php echo         $tipocosecha->Id; ?>">
									<!--<br>-->
									<div class="col-md-2">
										<div class="form-group">
...
$('.pagination').pagination({//llama a la funcion paginacion
		...
		onPageClick : function(pageNumber) {
			...
			$("#target-content").load(base + "TipoCosecha/Pagination/Page/" + pageNumber);
		}
	});
});
</script>