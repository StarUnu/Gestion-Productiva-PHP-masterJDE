            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="content">
                        ...
                        <br>
                        <form method="post" action="<?php echo BASE_URL;?>UnidadMedida/Guardar/">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required maxlength="100" class="form-control" name="Descripcion" placeholder="Descripcion" value="<?php echo $Unidadmedida->Descripcion ;?>">
                                        </div>
                                    </div>
                                    <input type="hidden" name="Id" value="<?php echo $Unidadmedida->Id; ?>">
                                    <!--<br>-->
                                        ...
                                        <tr>
                                            ...
                                            <td class="cell-actions">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <!--si elimina algo que que se esta utilizando me saldria error-->
...
$('.pagination').pagination({//llama a la funcion paginacion
        ...
        onPageClick : function(pageNumber) {
            ...
            $("#target-content").load(base + "UnidadMedida/Pagination/Page/" + pageNumber);
        }
    });
});
</script>